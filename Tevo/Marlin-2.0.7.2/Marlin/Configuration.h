...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {9.69}
    #define DEFAULT_Ki_LIST {0.48}
    #define DEFAULT_Kd_LIST {49.03}
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 29.93
  #define DEFAULT_bedKi 3.90
  #define DEFAULT_bedKd 313.83
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 95.2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 9, 72, 0 }
...
#define X_BED_SIZE 190  //No cooler-192, dual cooler-177 
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_END_POINT   { { 170, 10, (Z_MIN_POS + 1) } }
